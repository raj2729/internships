...
export const register = (name, email, password, linkedin, isEmployer, certificateOfIncorporation, pancard, gst, mobile, github, description, resume, profilePicture, education, location, website) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            "/user/userRegister",
            { name, email, password, linkedin, isEmployer, certificateOfIncorporation, pancard, gst, mobile, github, description, resume, profilePicture, education, location, website },
            config
        );
